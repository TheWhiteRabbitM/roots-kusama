...
|---|---|-------|------|----------|--------|
| 1 | Oral Ethnography & Book of Names | Off-chain | 4 weeks | 7,100 DOT |
| 2 | The Attestation Ceremony | Off → On bridge | 2 weeks | 9,300 DOT |
| 3 | On-Chain Registration | On-chain | 2 weeks | 7,100 DOT |
| 4 | The Social Experiment | Hybrid | 4 weeks | 7,550 DOT |
| 5 | Report & Replication Framework | Off-chain | 2 weeks | 3,650 DOT |
| | Contingency buffer | | | 2,200 DOT |
| | Crypto capital gains tax (33%) | | | 20,600 DOT |
| **TOTAL** | | | **3 months** | **62,500 DOT** |

> Requested funding: 62,500 DOT gross (net operational: 41,900 DOT / crypto tax 33%: 20,600 DOT)
...
This project operates under Italian law as a registered cultural association (APS). All crypto receipts are subject to Italian crypto capital gains tax (33%) at the time of conversion to fiat.
...
The 62,500 DOT budget includes Italian crypto capital gains tax (33%) as an explicit line item. This is not absorbed into operational costs it is reported transparently. All expenses will be documented with invoices and receipts. A financial report will accompany the Phase 5 deliverables.
...
This proposal is submitted to the **KSM Art & Social Experiments Initiative** of the Kusama Vision Initiative.

Reach the curators via the official Kusama bounty channels and the KSM Art & Social Experiments Initiative governance thread.
