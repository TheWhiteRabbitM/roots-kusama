...
| **TOTAL** | | | **3 months** | **62,189 DOT** |

> February 2026 · € 74,627 gross total
...
The 62,189 DOT budget includes Italian crypto income tax IRPEF (33%) as an explicit line item. This is not absorbed into operational costs it is reported transparently. All expenses will be documented with invoices and receipts. A financial report will accompany the Phase 5 deliverables.
...
Reach the curators via the official Kusama bounty channels and the Art & Social Experiments Bounty governance thread.
